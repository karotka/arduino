...
#   ARDMK_DIR     = /Users/karotka/Documents/Arduino/make
#
...
AVRDUDE_ARD_OPTS = -E -D -c $(AVRDUDE_ARD_PROGRAMMER) -b $(AVRDUDE_ARD_BAUDRATE) -P
ifeq ($(CURRENT_OS), WINDOWS)
...
$(TARGET_ELF): 	$(LOCAL_OBJS) $(CORE_LIB) $(OTHER_OBJS)
		$(CC) $(LDFLAGS) -o $@ $(LOCAL_OBJS) $(CORE_LIB) $(OTHER_OBJS) -Wl,-u,vfprintf -lprintf_flt -lm -lc $(LINKER_SCRIPTS)
